...
const loadEventsData = async (): Promise<AppEvent[]> => {
  try {
...
export const EventModal = (event: AppEvent) => {
...
export const EventCard = (e: AppEvent) => {
...
export const EventsSection = (title: string, events: AppEvent[]) => {
  return `
